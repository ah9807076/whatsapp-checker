...
function checkWhatsAppNumber(phoneNumber) {
  ...
  // Trim white spaces and ensure the number is in the correct format
  const normalizedNumber = phoneNumber.trim();
  return knownNumbers[normalizedNumber] !== undefined ? knownNumbers[normalizedNumber] : false;
}
app.listen(port, () => {
